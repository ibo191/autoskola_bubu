...
seoTitle: 'Co sleduje komisař u zkoušky v autoškole?'
description: 'Zjistěte, co komisař sleduje při závěrečné zkoušce v autoškole: bezpečnou jízdu, pozorování provozu, přednosti i samostatné rozhodování za volantem.'
...
branch: 'strizkov'
perex: 'Komisař není protivník. Ověřuje, zda dokážete řídit bezpečně, samostatně a předvídatelně.'
